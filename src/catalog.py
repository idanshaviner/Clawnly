...
Every group is 3 to 5 people (GROUP_MIN..GROUP_MAX), whatever the activity:
small enough that everyone actually meets everyone.
"""
...
def _a(id, name, neighborhood, where, tags, traits, days, parts, cost, outdoor):
...
ACTIVITIES = [
    ...
    _a("cp-lake-walk", "Sunrise loop around Lake Artemesia", "College Park", "Lake Artemesia trailhead",
       ["hiking", "running", "photography", "dog_walks"], ["early_mornings"], EVERY_DAY, ["morning"], "free", True),
    _a("cp-pickup", "Shootaround and a game of HORSE", "College Park", "campus rec center courts",
       ["basketball"], ["competitive"], EVERY_DAY, ["afternoon", "evening"], "free", False),
    _a("cp-trivia", "Trivia night as one team", "College Park", "a Route 1 pub",
       ["trivia"], ["loud_places", "competitive", "late_nights"], [1, 3], ["evening"], "low", False),
    ...
    _a("cp-soccer", "Soccer kick-around", "College Park", "the intramural fields",
       ["soccer"], ["competitive"], [5, 6], ["morning", "afternoon"], "free", True),
    _a("cp-frisbee", "Frisbee toss", "College Park", "McKeldin Mall lawn",
       ["frisbee", "running"], [], [5, 6], ["afternoon"], "free", True),
    _a("cp-watch", "Watch the game together", "College Park", "a sports bar with big screens",
       ["watch_sports"], ["crowds", "loud_places"], [5, 6], ["afternoon", "evening"], "low", False),
    _a("cp-movie", "Indie movie night", "College Park", "the campus cinema",
       ["movies"], [], [3, 4, 5], ["evening"], "low", False),

    # Hyattsville
    _a("hy-kayak", "Kayaking on the Anacostia", "Hyattsville", "Bladensburg Waterfront boat rentals",
       ["kayaking", "paddleboarding"], ["early_mornings"], [5, 6], ["morning", "afternoon"], "mid", True),
    ...
    _a("hy-market", "Farmers market stroll + coffee", "Hyattsville", "the Saturday farmers market",
       ["farmers_market", "cooking", "photography"], [], [5], ["morning"], "low", True),
    _a("hy-music", "Live music at a small venue", "Hyattsville", "a listening room on Baltimore Ave",
       ["live_music", "dance"], ["loud_places", "late_nights"], [3, 4, 5], ["evening"], "mid", False),
    _a("hy-pottery", "Open studio pottery", "Hyattsville", "a community clay studio",
       ["pottery"], ["spending_money"], [1, 3, 6], ["evening", "afternoon"], "mid", False),
    ...
    _a("rp-run", "Easy 5K run together", "Riverdale Park", "Riverdale Park station plaza",
    ...
    _a("rp-books", "Book club over coffee", "Riverdale Park", "a coffee shop near the town center",
       ["book_club"], [], [0, 3, 6], ["evening", "afternoon"], "low", False),
    ...
    _a("rp-chess", "Chess and coffee", "Riverdale Park", "a cafe with outdoor tables",
       ["chess", "board_games"], [], [0, 2, 6], ["afternoon", "evening"], "low", False),
    ...
    _a("ch-museum", "Late-night museum visit", "Columbia Heights", "a Smithsonian museum downtown",
       ["museums", "photography"], ["crowds"], [3, 4], ["evening"], "free", False),
    ...
    _a("ch-watch", "Watch the match at a soccer bar", "Columbia Heights", "a soccer bar on 14th St",
       ["watch_sports", "soccer"], ["crowds", "loud_places"], [5, 6], ["morning", "afternoon"], "low", False),
    _a("ch-hike", "Rock Creek Park hike", "Columbia Heights", "Rock Creek Park trailhead",
       ["hiking", "photography", "dog_walks"], [], [5, 6], ["morning", "afternoon"], "free", True),
]
